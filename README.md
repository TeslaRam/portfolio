...
Also there is my documentation from _high school graduation_ exam.

- **2TSort**: Sorting algorithm created by me, public page: [2TSort](https://github.com/TeslaRam/2TSort)
- **KalenTRis**: my personal calendar
- **NEW_DAWN**: App for [Nové Svitanie](http://novesvitanie.sk/) and [New Dawn CZ](https://www.newdawn.cz/) conferention
- **PerWiber**: music player system
- - **PWA**: Android
- - **PWB**: Backend
- - **PWC**: Desktop
- **Shapp**: Documentation for my _high school graduation_ project, in slovak language
- **TRons**: Kotlin Multiplatform library with items I often use
